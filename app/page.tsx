    ...
    <div className="img-bg h-screen relative">
      ...
      <form>
        <div className="glass w-[400px] max-sm:w-80 flex justify-center items-center flex-col p-9 absolute top-14 left-8 max-md:top-1/2 max-md:left-1/2 max-md:-translate-x-1/2 max-md:-translate-y-1/2">
              ...
              <div>
                <label className="block text-slate-100 mb-2 text-xl right-0">Username</label>
              ...
              <input type="submit" className="bg-white mt-10 text-center text-xl font-bold h-10 w-48 mx-auto rounded-lg hover:bg-black hover:text-slate-100 cursor-pointer duration-200"  onClick={(e) => {
                e.preventDefault();
